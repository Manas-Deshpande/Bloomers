...
<%
	...
	PreparedStatement ps=con.prepareStatement("select f_name,email,phone_no,venue,no_of_tress,calendar,message,response_time from campaign");
    ...
    out.println("<th>No_of_tress</th>");
    out.println("<th>Calendar</th>");
	...
	while(rs.next())
	{
         ...
         out.println("<td>" + rs.getString("no_of_tress") + "</td>");
         out.println("<td>" + rs.getString("calendar") + "</td>");
